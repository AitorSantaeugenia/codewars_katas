...
The strings representing a given language will always be formatted in the same way (e.g. 'JavaScript' will always be formatted with 
upper-case 'J' and 'S'.
*/
function findAdmin(list, lang) {
	...
	return list.filter((key, key2) => key.language === lang && key.githubAdmin === 'yes');
}
